      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          {racesLoading ? (
            ...
            <p className="text-slate-400 text-sm">Không có cuộc đua nào đang mở cược.</p>
          ) : (
            ...
            <>
              ...
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                ...
                {participantsLoading ? (
                  ...
                  <p className="text-slate-400 text-sm">Chưa có ngựa đăng ký cuộc đua này.</p>
                ) : (
                  ...
                  <form onSubmit={handleBetSubmit} className="space-y-8">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          {[['win','Thắng'],['place','Top 2'],['show','Top 3']].map(([val, label]) => (
                            <button
                              key={val}
                              type="button"
                              onClick={() => setPrediction(p => ({ ...p, type: val }))}
                    ...
                    <div className="pt-6 border-t border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                      ...
                      <button
                        type="submit"
                        disabled={submitting}
                        className="bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white px-10 py-4 rounded-full font-black shadow-xl transition-all hover:-translate-y-1 active:scale-95"
                      >
                        {submitting ? 'Đang gửi...' : 'GỬI DỰ ĐOÁN'}
                      </button>
                    </div>
